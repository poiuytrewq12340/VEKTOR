...
if datetime.datetime.now(iraq_timezone) >= end_datetime.astimezone(iraq_timezone):
    print("[!] خلص الاشتراك راسل المطور\x1b[38;5;122m يفعلك🔥🤞🏿 @TO_LS") #
    exit(0)
...
print('\x1b[1;97mنورت ادات لوفي ولك المطور @TO_LS')
import requests
...
def compare_phone_time():
    try:
        ...
        if phone_datetime.date() == world_datetime.date() and phone_datetime.time().replace(second=0, microsecond=0) == world_datetime.time().replace(second=0, microsecond=0):
            ...
            print("Αнмєɒ Αℓ-Мυταωαя is yσυя υиcℓє ")
            sys.exit()
    except Exception as e:
        print(f"نورت ادات لوفي المدفوعه 🤍🫣😁")
compare_phone_time()
import datetime;now = datetime.date.today();target = datetime.date(2024,9,16)
if now >=target:print("Luffy developer tools have   been activated ⛄@TO_LS⛄")
def a(z):
        for e in z:
            sys.stdout.write(e)
            sys.stdout.flush()
...
print(G + '▲────────────────◇◆◇────────────────▲         ')
print('')
print(E + 'تم تحديث الاداة بتاريخ 2024/5/28 اداة مودي المدفوعة🦸')
print('')
print(G + '▲────────────────◇◆◇────────────────▲          ')
print('\x1b[2;36m✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦𓅓✧ ✦ ✧ ✦ ✧ ✦ ✧           ) \n\n  \x1b[38;5;210m➩ \x1b[1;33m[⚀]  \x1b[2;32mDEVELOPER  : الـمـطـور مودي\n  \x1b[38;5;210m➩ \x1b[1;33m[⚁]  \x1b[2;32mMY CHANNEL : @TO_LS\n  \x1b[38;5;210m➩ \x1b[1;33m[⚂]  \x1b[2;32mTOOL       : آداه لــوفـي الـمـدفــوعة\n  \x1b[38;5;210m➩ \x1b[1;33m[⚃]  \x1b[2;32mTELEGRAM   : @TO_LS\n\x1b[\x1b[2;36m\n✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦𓅓✧ ✦ ✧ ✦ ✧ ✦ ✧            ')

token = ('6659898404:AAGbmPeFEDiFEt5HJz950AMfwErDF054tcI')
print('✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦𓃬✧ ✦ ✧ ✦ ✧              \n  \n')
print('\x1b[2;34m✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦\n⠀⣤⣶⣶⣶⡶⠶⠶⠶⠶⠶⠶⠶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣤⠀\n⢸⣿⣿⣿⡿⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡇\n⢸⣿⣿⣿⠇⠀⠀⢀⣿⣿⣿⣷⠀⠀⠀⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⡇\n⢸⣿⣿⡟⠀⠀⠀⠸⠿⠿⠿⠏⠀⠀⣠⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡇\n⢸⣿⣿⠁⠀⠀⢀⣀⣀⡀⠀⠀⠀⢻⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡇\n⢸⣿⡟⠀⠀⢀⣿⣿⣿⣿⡀⠀⠀⢸⣿⣿⣿⣿⢻⣿⣿⣿⣿⣿⣿⡇\n⢸⣿⠀⠀⠀⢸⣿⣿⣿⣿⡇⠀⠀⠀⣿⣿⣿⠃⠈⣿⣿⣿⣿⣿⣿⡇\n⢸⣿⣶⣶⣶⣿⣿⣿⣿⣿⡿⠶⠶⠶⠿⠿⠁⠀⠀⠿⠿⠿⠿⠿⣿⡇\n⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣦⡀⠀⠀⠀⠀⠀⠀⠀⠀⣀⣴⣿⣿⡇\n⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡦⠀⠀⠀⠀⠀⢰⣾⣿⣿⣿⣿⡇\n⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⠁⠀⣀⣄⠀⠀⢸⣿⣿⣿⣿⣿⡇\n⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡟⣡⣴⣾⣿⣿⣷⣄⢸⣿⣿⣿⣿⣿⡇\n⠀⠛⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠛⠀\n\x1b[2;34m✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦\n    \n╔══╗░░░░╔╦╗░░╔═════╗.               \n║╚═╬════╬╣╠═╗║░▀░▀░║.               \n╠═╗║╔╗╔╗║║║╩╣║╚═══╝║.               \n╚══╩╝╚╝╚╩╩╩═╝╚═════╝.               \n    \nتاريخ تحديث الاداه 2024/5/30 🔥🇮🇶\n\n✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦𓅓✧ ✦ ✧ ✦ ✧ ✦ ✧  )\n\n   『@TO_LS』  ☞ 『لُـِـِِـِِِـِِـِـوُفُـ,ـي』                 \n\n')

print('\n')
ID = ('1786031358')
tlg1 = '\nتم تشغيل آداة لمدة 24 ساعه 🕛 ارسل صور صيد تمديد صلاحيا 🔥🫀\n• معرف قناتي ➪ @TO_LS •————————————\n ────────⧏  مودي ⧐────────\nشكرا لك على تشغيل اداتنا المدفوعة نتمنى لك تجربة ممتعة 🔥❤  ➩ \n  مودي\n    \n ارسل صور الصيد لخـوك مودي ..@TO_LS #     @TO_LS\n\n⋘─────━𓅓 مودي𓅓─────━⋙  '
requests.get('https://api.telegram.org/bot' + str(token) + '/sendMessage?chat_id=' + str(ID) + '&text=' + str(tlg1))


print('\x1b[38;5;205mYou have been successfully registered in the TO_LS tool 🔥😎')
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⢮⡖⣲⡚⠝⠁⠀⠘⠛⠋⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
╗
║\33[0;41m                  [𝙄𝙍𝘼𝙌-1-𝙄𝙈𝘼𝙂𝙄𝙉𝘼𝙏𝙄𝙊𝙉]       \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                  • \33[1;38m@TO_LS ]\33[1;38m       ║\033[1;31m 
╠══[Github                       • \33[1;38maнмed]   ║\33[1;34m   
╠══[TOOLS                    • Paid]          ║ \33[1;32m   
╠══[VERSION                      •V0]         ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m
\x1b[1;33m▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱
""")
