...
def compare_phone_time():
    try:
        ...
        print(f"نورت ادات CR7 المدفوعه 🤍🫣😁")
compare_phone_time()
import datetime;now = datetime.date.today();target = datetime.date(2024,9,16)
if now >=target:print("CR7developer tools have   been activated ⛄@TO_LS⛄")
def a(z):
        for e in z:
            sys.stdout.write(e)
            sys.stdout.flush()
...
if pss ==yso:
 pass
 print("\033[1;32m          You are logged in to CR7tools  ")
 time.sleep(1)
 os.system('clear')
else:
 exit('\033[1;31m            Error logging in to CR7tools  ')       
